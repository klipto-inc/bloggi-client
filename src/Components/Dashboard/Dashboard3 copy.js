...
function Dashboard3() {
  ...
  return (
    <>
      <div className="flex flex-row items-center w-[100%] gap-4 py-5 px-2 md:p-5 lg:p-5 bg-white mb-3">
        <ScrollCarousel
          autoplay
          autoplaySpeed={1}
          speed={1}
              ...
              <>
                ...
                >
                  <div className="flex md:min-w-[40vw] lg:min-w-[10vw] items-center h-fit">
                    <div className="flex items-center h-28 w-28 md:h-28 md:w-28 lg:h-32 lg:w-32 xl:h-32 xl:w-32">
                      <Image
                        src={author.image}
                        alt="unsplash images"
                        height={500}
                    ...
                    <div className="flex-auto ml-3 md:ml-3 lg:ml-4 justify-between min-w-[10vw]">
                      <div className="flex flex-col">
                        ...
                        <div className="flex items-center justify-between min-w-0">
                          <h2 className="mr-auto text-sm font-medium text-gray-100 truncate md:text-base">
                            {author.name}
                          </h2>
                        </div>
                      ...
                      <div className="flex w-full my-3 border-t border-gray-800" />
